...
<div class="body_openwindow datawinlose">
    <div class="sec_openwindow">
        <div class="table_detailhistorygameds">
            ...
            <a href="/memberlistds/winloseyear/{{ $username }}" class="cctkembali">
                ...
                <tbody>
                    ...
                    @foreach ($data as $d)
                        <tr>
                            <td>
                                <a
                                    href="/memberlistds/winloseday/{{ $d->username }}/{{ $d->year }}/{{ $d->month }}">{{ date('M', mktime(0, 0, 0, $d->month, 1)) }}({{ $d->year }})</a>
                            </td>
